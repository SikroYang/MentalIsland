...
<template>
  <div>
    ...
    <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading"
      ...
      <el-table-column align="center" label="评论内容" width="500">
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="60%" @click='closeDialog("edit")'>
      <el-form label-width="120px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="帖子Id" prop="PostId">
          <el-input size="small" v-model="editForm.PostId" auto-complete="off" placeholder="请输入帖子Id"></el-input>
        </el-form-item>
        <el-form-item label="评论内容" prop="Content">
          <el-input type="textarea" :autosize="{ minRows: 3, maxRows: 12 }" size="small" v-model="editForm.Content"
            auto-complete="off" placeholder="请输入评论内容"></el-input>
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    handleEdit: function (index, row) {
      ...
      if (row != undefined && row != 'undefined') {
        ...
        this.title = '添加评论'
        var postId = this.formInline.Id ? this.formInline.Id : ''
        // console.log(postId);
        this.editForm.Id = ''
        this.editForm.PostId = postId
